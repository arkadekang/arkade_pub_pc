...
#
# $Id: vars_common.pl 6532 2020-09-15 21:28:16Z CloyceS $
...
$::current_version = '1.1.5'; # UPDATE - version: Adjust by hand
$::current_runcpu = 6440; # UPDATE - last changed revision for bin/harness/runcpu: Adjust by hand
...
my $version = '$LastChangedRevision: 6532 $ '; # Make emacs happier
...
$::nonvolatile_config = {
    ...
    'orig_argv'                 => [ shellwords($ENV{'SPEC_RUNSPEC'}), @ARGV ], # Stash of ARGV as supplied by the user
