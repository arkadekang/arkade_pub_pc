...
ar='ar'
archlib='.../../lib/perl5/5.24.0/x86_64-linux'
archlibexp='.../../lib/perl5/5.24.0/x86_64-linux'
archname64=''
...
cccdlflags='-fPIC'
ccdlflags='-Wl,-E'
ccflags='-I/spec/cpu2017/tools/output/include -fwrapv -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
ccflags_uselargefiles='-D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
ccname='gcc'
ccsymbols=''
ccversion=''
cf_by='cloyce'
cf_email='cloyce@ol6build.localdomain'
cf_time='Wed Sep 14 14:42:25 PDT 2016'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg10='-Aoptimize=-O3'
config_arg11='-Aoptimize=-m64'
config_arg12='-Ddosuid=undef'
config_arg13='-Dprefix=/spec/cpu2017/tools/output'
config_arg14='-Dd_bincompat3=undef'
config_arg15='-A'
config_arg16='ldflags=-L/spec/cpu2017/tools/output/lib'
config_arg17='-A'
config_arg18='ccflags=-I/spec/cpu2017/tools/output/include'
config_arg19='-Uuse5005threads'
config_arg1='-dOes'
config_arg20='-Uuseshrplib'
config_arg21='-Duserelocatableinc'
config_arg22='-Dnoextensions=B-Debug,B-Lint,CPAN,CPANPLUS,CPANPLUS-Dist-Build,DB_File,Devel-PPPort,IPC-SysV,Locale-Codes,Locale-Maketext-Simple,Pod-LaTeX,Sys-Syslog,Term-ANSIColor,Term-Cap,Term-UI,B,Devel-Peek,Devel-SelfStubber,GDBM_File,I18N-Langinfo,NDBM_File,ODBM_File,VMS-DCLsym'
config_arg2='-Ud_flock'
config_arg3='-Uplibpth='
config_arg4='-Aplibpth=/lib64'
config_arg5='-Aplibpth=/usr/lib64'
config_arg6='-Aplibpth=/lib'
config_arg7='-Aplibpth=/usr/lib'
config_arg8='-Uoptimize='
config_arg9='-Aoptimize=-m64'
config_argc='22'
config_args='-dOes -Ud_flock -Uplibpth= -Aplibpth=/lib64 -Aplibpth=/usr/lib64 -Aplibpth=/lib -Aplibpth=/usr/lib -Uoptimize= -Aoptimize=-m64 -Aoptimize=-O3 -Aoptimize=-m64 -Ddosuid=undef -Dprefix=/spec/cpu2017/tools/output -Dd_bincompat3=undef -A ldflags=-L/spec/cpu2017/tools/output/lib -A ccflags=-I/spec/cpu2017/tools/output/include -Uuse5005threads -Uuseshrplib -Duserelocatableinc -Dnoextensions=B-Debug,B-Lint,CPAN,CPANPLUS,CPANPLUS-Dist-Build,DB_File,Devel-PPPort,IPC-SysV,Locale-Codes,Locale-Maketext-Simple,Pod-LaTeX,Sys-Syslog,Term-ANSIColor,Term-Cap,Term-UI,B,Devel-Peek,Devel-SelfStubber,GDBM_File,I18N-Langinfo,NDBM_File,ODBM_File,VMS-DCLsym'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
gccansipedantic=''
gccosandvers=''
gccversion='4.4.4 20100726 (Red Hat 4.4.4-13)'
getgrent_r_proto='0'
getgrgid_r_proto='0'
getgrnam_r_proto='0'
...
incpath=''
incpth='/usr/local/include /usr/lib/gcc/x86_64-redhat-linux/4.4.4/include /usr/include'
inews=''
initialinstalllocation='/spec/cpu2017/tools/output/bin'
installarchlib='.../../lib/perl5/5.24.0/x86_64-linux'
installbin='/spec/cpu2017/tools/output/bin'
installhtml1dir=''
installhtml3dir=''
installman1dir='.../../man/man1'
installman3dir='.../../man/man3'
installprefix='/spec/cpu2017/tools/output'
installprefixexp='.../..'
installprivlib='.../../lib/perl5/5.24.0'
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.24.0/x86_64-linux'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
lddlflags='-shared  -m64 -O3 -m64 -L/spec/cpu2017/tools/output/lib -L/usr/local/lib -fstack-protector'
ldflags=' -L/spec/cpu2017/tools/output/lib -fstack-protector -L/usr/local/lib'
...
libsfound=' /usr/lib64/libpthread.so /usr/lib64/libnsl.so /usr/lib64/libdb.so /usr/lib64/libdl.so /usr/lib64/libm.so /usr/lib64/libcrypt.so /usr/lib64/libutil.so /usr/lib64/libc.so'
libspath=' /usr/local/lib /usr/lib /lib64 /usr/lib64 /lib /usr/local/lib64'
...
myhostname='ol6build'
myuname='linux ol6build.localdomain 2.6.32-100.28.5.el6.x86_64 #1 smp wed feb 2 18:40:23 est 2011 x86_64 x86_64 x86_64 gnulinux '
n='-n'
need_va_copy='define'
...
perladmin='cloyce@ol6build.localdomain'
perllibs='-lpthread -lnsl -ldl -lm -lcrypt -lutil -lc'
perlpath='/spec/cpu2017/tools/output/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
plibpth=' /lib64 /usr/lib64 /lib /usr/lib'
pmake=''
pr=''
prefix='.../..'
prefixexp='.../..'
...
sig_size='69'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.24.0/x86_64-linux'
sitearchexp='.../../lib/perl5/site_perl/5.24.0/x86_64-linux'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
...
st_ino_sign='1'
st_ino_size='8'
startperl='#!/spec/cpu2017/tools/output/bin/perl'
startsh='#!/bin/sh'
static_ext=' '
stdchar='char'
...
ccflags_nolargefiles='-I/spec/cpu2017/tools/output/include -fwrapv -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include  -D_FORTIFY_SOURCE=2'
ldflags_nolargefiles=' -L/spec/cpu2017/tools/output/lib -fstack-protector -L/usr/local/lib'
