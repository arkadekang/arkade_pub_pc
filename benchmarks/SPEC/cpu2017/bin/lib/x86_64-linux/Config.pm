...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/perl5/5.24.0/x86_64-linux'),
    ...
    osname => 'linux',
    osvers => '2.6.32-100.28.5.el6.x86_64',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/perl5/5.24.0'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/perl5/site_perl/5.24.0/x86_64-linux'),
